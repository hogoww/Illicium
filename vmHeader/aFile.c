...
static int setInterpreter(struct VirtualMachine *anInterpreter)
{
 ...
 ok = ((interpreterProxy->majorVersion()) == (1))
  && ((interpreterProxy->minorVersion()) >= (15));
 if (ok) {
   }
 return ok;
}int main();
...
static char _m[] = "aFile.c";
void* MyBadPlugin_exports[][3] = {
 {(void*)_m, "main", (void*)main},
 {(void*)_m, "factorialR", (void*)factorialR},
